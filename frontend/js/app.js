// VoltFlow Full Controller - Preserves All Original Content + All New Features

// Point 15: 5 Lucknow Hubs with Station-Wise Pricing Models[cite: 1]
let fleetStations = [
  {
    id: "CS-LKO-01",
...
// Point 11: Real-World Diverse SOCs & Deadlines (All 8 EVs Preserved)[cite: 1]
let fleetVehicles = [
  {
    vehicleId: "EV-001",
...
// Cost-Aware Calculation (Point 16, 17, 19)[cite: 1]
...
// 1. Render Cost-Aware Orchestration Table[cite: 1]
...
// 3. Station Cost Comparison[cite: 1]
...
// 5. Vehicles Table with Filter[cite: 1]
...
// 8. Vehicle Details Modal[cite: 1]
...
// Interactive Leaflet Map[cite: 1]
function initMap() {
...
function initAllCharts() {
  // 1. Dashboard Live Hub Chart[cite: 1]
  ...
  // 2. Dashboard Energy Chart[cite: 1]
  ...
  // 3. Analytics Before vs After[cite: 1]
  ...
  // 5. Analytics Green Chart[cite: 1]
  ...
  if (ctx5) {
    new Chart(ctx5, {
      ...
      data: {
        ...
        datasets: [{
          label: 'CO₂ Avoided (kg)',
          data: [180, 210, 240, 195, 260, 220, 215],
          borderColor: '#10b981',
          tension: 0.3
        }]
      },
